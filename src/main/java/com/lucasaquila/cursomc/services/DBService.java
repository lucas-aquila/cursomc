...
import com.lucasaquila.cursomc.domain.Pagamento;
import com.lucasaquila.cursomc.domain.PagamentoComBoleto;
import com.lucasaquila.cursomc.domain.PagamentoComCartao;
...
import com.lucasaquila.cursomc.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "lucas-aquila@outlook.com", "36378912377", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Lucas Áquila", "lucas-aquila@hotmail.com", "39411094805", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli1.getTelefones().addAll(Arrays.asList("47471621", "35251472"));
	
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Rodolfo Amoedo", "987", null, "Três Bandeiras", "85862265", cli2, c2);
